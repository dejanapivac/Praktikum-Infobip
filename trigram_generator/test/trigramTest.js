...
//----------OVDJE KRECE ZA NOVI ZADATAK s brojem ono Lucia poslala u grupu-------

//describe je grupa testove ovdje se zove dvigram generator

// { "I" : ["wish"], "wish" : ["I"]} --> DVIGRAM

describe('dvigram generator', function () {
  it('dvigram should be a function', function () {
...
// const { trigramGenerator, generateChunks } = require('../trigram_generator.js');
// var expect = chai.expect;
// var should = chai.should;

// describe("trigram_generator problem TDD", function() {
...
//     it('should return correct trigram for less than 3 words', function () {
//         expect(trigramGenerator('I wish')).to.eql(new Map());
//     });
...
//     it("should return correct trigram 4 words input", function(){
...
//     it("generateChunks shoulf return correct array for 3 words input", function(){
//         expect(generateChunks(["I", "wish", "I"])).to.eql([["I", "wish", "I"]]);
//     });

//     it("generateChunks shoulf return correct array for 4 words input", function(){
//         expect(generateChunks(["I", "wish", "I"])).to.eql([["I", "wish", "I"]]);
//     });
// })
// });